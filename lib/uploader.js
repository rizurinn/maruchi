...
async function catbox(buffer, customFilename = null) {
    ...
    try {
        ...
        console.error("Catbox error:", err.message || err);
        throw err;
    }
}
...
async function uguu(buffer, customFilename = null) {
    ...
    try {
        ...
        console.error("Uguu error:", err.message || err);
        throw err;
    }
}
...
async function quax(buffer, customFilename = null) {
    ...
    try {
        ...
        console.error("Qu.ax error:", err.message || err);
        throw err;
    }
}
...
async function picu(buffer) {
    ...
    try {
        ...
        console.error("Put.icu error:", err.message || err);
        throw err;
    }
}
...
async function tmpfiles(buffer, customFilename = null) {
    ...
    try {
        ...
        console.error("Tmpfiles error:", err.message || err);
        throw err;
    }
}
...
async function pomf2(buffer, customFilename = null) {
    ...
    try {
        ...
        console.error("Pomf2 error:", err.message || err);
        throw err;
    }
}
...
async function uploadFile(buffer, customFilename = null, preferredServices = null) {
    ...
    throw new Error(`All upload services failed. Errors: ${JSON.stringify(errors, null, 2)}`);
}
